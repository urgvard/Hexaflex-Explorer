        ...
        <div className="p-6 pb-2 shrink-0 relative">
            ...
            <div className="flex items-center justify-between mb-4">
                 <div className="flex items-center gap-4">
                    <button onClick={onBack || onClose} className={`p-2 rounded-full md:hidden ${textMuted}`} aria-label="Go back">
                 ...
                 <button onClick={onClose} className={`p-2 rounded-full transition-colors hidden md:block hover:bg-black/5 ${textMuted}`} aria-label="Close panel">
                    <X className="w-6 h-6" />
                 </button>
            </div>
        </div>
